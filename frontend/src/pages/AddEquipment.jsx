          ...
          <form className="add-form-card glass" onSubmit={handleSubmit}>
            <div className="add-form-grid">
              ...
              <div className="form-group add-form-full">
                ...
                <input className="form-input" id="title" name="title" placeholder="e.g. Raspberry Pi Zero 2W" value={form.title} onChange={set('title')} required />
              </div>

              <div className="form-group add-form-full">
                <label className="form-label">Description</label>
                <input className="form-input" id="description" name="description" placeholder="Short description of the hardware" value={form.description} onChange={set('description')} />
              </div>

              <div className="form-group">
                <label className="form-label">Category</label>
                <select className="form-select" id="category" name="category" value={form.category} onChange={set('category')}>
              ...
              <div className="form-group">
                ...
                <select className="form-select" id="condition" name="condition" value={form.condition} onChange={set('condition')}>
                  <option>New</option>
              ...
              <div className="form-group">
                ...
                <input className="form-input" id="price" name="price" type="number" min="0" step="0.01" placeholder="e.g. 1500" value={form.price} onChange={set('price')} />
              </div>

              <div className="form-group">
                <label className="form-label">Rental Price / Day (₹) — leave blank if sale only</label>
                <input className="form-input" id="rental_price_per_day" name="rental_price_per_day" type="number" min="0" step="0.01" placeholder="e.g. 150" value={form.rental_price_per_day} onChange={set('rental_price_per_day')} />
              </div>
